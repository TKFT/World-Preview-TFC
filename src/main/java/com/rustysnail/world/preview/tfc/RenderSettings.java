...
public class RenderSettings
{
    ...
    public enum RenderMode
    {
        ...
        TFC_ROCK_TOP(8L, false),     // Surface/top rock layer
        TFC_ROCK_MID(9L, false),     // Middle rock layer
        ...
        TFC_CROP_SUITABILITY(16L, false), // Annual complete-harvest potential for the selected crop
        TFC_PERENNIAL_SUITABILITY(17L, false); // Mature perennial production opportunities
