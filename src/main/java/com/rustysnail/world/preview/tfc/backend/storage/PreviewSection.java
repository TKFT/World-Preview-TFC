...
public abstract class PreviewSection implements Serializable
{
    ...
    public abstract void set(int x, int z, short value);

    public abstract List<PreviewStruct> structures();

    public abstract void addStructure(PreviewStruct structureData);

    public abstract List<PreviewFeature> features();

    public abstract void addFeature(PreviewFeature feature);
    ...
    public record PreviewFeature(short featureTypeId, BlockPos center) implements Serializable
    {
    }
}
