...
public class HeightmapTab implements Tab
{
    ...
    public void doLayout(ScreenRectangle screenRectangle)
    {
        ...
        int maxYRowY = bottomL - 24;
        this.maxYLabel.setPosition(leftL, maxYRowY);
        this.maxYLabel.setWidth(100);
        this.maxYBox.setPosition(leftL + 100, maxYRowY);
        this.maxYBox.setWidth(secWidth - 100);
        int minYRowY = maxYRowY - 24;
        this.minYLabel.setPosition(leftL, minYRowY);
        this.minYLabel.setWidth(100);
        this.minYBox.setPosition(leftL + 100, minYRowY);
        ...
        this.heightPresetList.setSize(secWidth, minYRowY - topL - 4);
